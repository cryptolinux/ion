...
Linux ARM/aarch64| [![Download ion for ARM Linux](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc6/ion-3.1.00-arm-linux-gnueabihf.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc6/ion-3.1.00-aarch64-linux-gnueabihf.tar.gz) | [![Download ion for aarch64 Linux](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc6/ion-3.1.0-aarch64-linux-gnu.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc6/ion-3.1.00-aarch64-linux-gnu.tar.gz)
