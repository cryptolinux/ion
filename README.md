...
- Downloads
    ...
    | OS | 32-Bit | 64-Bit |
    :---: | ---: | ---: |
    MacOS/OSX | [![Download ion Setup for OSX 32-bit](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-osx-unsigned.dmg.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-osx-unsigned.dmg) | [![Download ion Setup for OSX 64-bit](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-osx64.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-osx64.tar.gz) |
    Windows XP/Vista/7/10 |  [![Download ion Setup for Windows 32-bit](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-win32-setup-unsigned.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-win32-setup-unsigned.exe) | [![Download ion Setup for Windows 64-bit](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.0-win64-setup-unsigned.exe.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-win64-setup-unsigned.exe) |
    | | [![Download ion binaries for Windows 32-bit](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-win32.zip.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-win32.zip) | [![Download ion binaries for Windows 64-bit](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-win64.zip.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-win64.zip) |
    Linux | [![Download ion for Linux 32-bit (i686)](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.0-i686-pc-linux-gnu.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-i686-pc-linux-gnu.tar.gz) | [![Download ion for Linux 64-bit (x86_x64)](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-x86_64-linux-gnu.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-x86_64-linux-gnu.tar.gz)
    || [![Download ion for ARM Linux](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.00-arm-linux-gnueabihf.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-aarch64-linux-gnueabihf.tar.gz) | [![Download ion for aarch64 Linux](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/ion-3.1.0-aarch64-linux-gnu.tar.gz.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/ion-3.1.00-aarch64-linux-gnu.tar.gz)


    Download checksums: [![Download SHA256SUMS.asc](https://img.shields.io/github/downloads/cevap/ion/v3.1.0-rc2/SHA256SUMS.asc.svg)](https://github.com/cevap/ion/releases/download/v3.1.0-rc2/SHA256SUMS.asc)
