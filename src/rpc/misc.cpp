...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized ion balance of the wallet\n"
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"iTUsSxT1BrUsJj2BuBb4mLD1dhGbyyhrxn\\\",\\\"ibhWLtq6WuAUCprQnBcMpgwLXMiLQX5H5J\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"iTUsSxT1BrUsJj2BuBb4mLD1dhGbyyhrxn\\\",\\\"ibhWLtq6WuAUCprQnBcMpgwLXMiLQX5H5J\\\"]\"")
        ;
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Ion features */
    { "ion",               "mnsync",                 &mnsync,                 true,  {} },
    { "ion",               "spork",                  &spork,                  true,  {"value"} },
