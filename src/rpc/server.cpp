...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 38600000.0)
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"ion", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ion", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ion", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        ...
        {"ion", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ion", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ion", "listmasternodeconf", &listmasternodeconf, true, true, false},
        ...
        {"ion", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ion", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ion", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ion", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ion", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ion", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ion", "checkbudgets", &checkbudgets, true, true, false},
        {"ion", "mnsync", &mnsync, true, true, false},
        {"ion", "spork", &spork, true, true, false},
        {"ion", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ion-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12705/\n";
}
