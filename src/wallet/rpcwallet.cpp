...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" \"tabby\"") + HelpExampleRpc("setaccount", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\"") + HelpExampleRpc("getaccount", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\""));
...
UniValue sendtoaddressix(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddressix", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 0.1") +
            HelpExampleCli("sendtoaddressix", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 0.1 \"donation\" \"seans outpost\"") +
            HelpExampleRpc("sendtoaddressix", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\", 0.1, \"donation\", \"seans outpost\""));
    ...
    SendMoney(address.Get(), nAmount, false, wtx, true);
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            ...
            HelpExampleCli("signmessage", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" \"my message\"") +
            "\nVerify the signature\n" +
            HelpExampleCli("verifymessage", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" +
            HelpExampleRpc("signmessage", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\", \"my message\""));
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            HelpExampleCli("getreceivedbyaddress", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" +
            HelpExampleCli("getreceivedbyaddress", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" +
            HelpExampleCli("getreceivedbyaddress", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 6") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("getreceivedbyaddress", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\", 6"));
...
UniValue movecmd(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 5)
        throw std::runtime_error(
            ...
            "3. amount            (numeric, required) Quantity of ION to move between accounts.\n"
            ...
            "\nMove 0.01 ION from timotei to akiko with a comment\n" +
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw std::runtime_error(
            ...
            HelpExampleCli("sendfrom", "\"\" \"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n" +
            HelpExampleCli("sendfrom", "\"tabby\" \"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendfrom", "\"tabby\", \"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\", 0.01, 6, \"donation\", \"seans outpost\""));
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw std::runtime_error(
            ...
            HelpExampleCli("sendmany", "\"\" \"{\\\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\\\":0.01,\\\"igJt12PmSYuy6Sz4WfXc7iyxcTCb3LdtUK\\\":0.02}\" "
                "1 \"\" \"[\\\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\\\",\\\"igJt12PmSYuy6Sz4WfXc7iyxcTCb3LdtUK\\\"]\"") +
            "\nAs a json rpc call\n" +
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw std::runtime_error(
            ...
            HelpExampleCli("sendtoaddress", "\"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending IONs\n" +
...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total ION balance of the wallet\n"
            "  \"unconfirmed_balance\": xxx, (numeric) the total unconfirmed balance of the wallet in ION\n"
            "  \"immature_balance\": xxxxxx, (numeric) the total immature balance of the wallet in ION\n"
...
UniValue getzerocoinbalance(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            "getzerocoinbalance\n"
            "\nReturn the wallet's total xION balance.\n" +
            HelpRequiringPassphrase() + "\n"

            "\nResult:\n"
            "amount         (numeric) Total xION balance.\n"
...
UniValue listmintedzerocoins(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nList all xION mints in the wallet.\n" +
            HelpRequiringPassphrase() + "\n"
            ...
            "    \"xION ID\": \"xxx\",   (string) Pubcoin in hex format.\n"
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    std::set<CMintMeta> setMints = pwalletMain->xionTracker->ListMints(true, fMatureOnly, true);
    ...
    if (fVerbose) {
        for (auto m : setMints) {
            ...
            objMint.push_back(Pair("xION ID", m.hashPubcoin.GetHex()));     // PubCoin
            ...
            if (m.hashStake == 0) {
                ...
                if (pwalletMain->GetMint(m.hashSerial, mint)) {
                    ...
                    pwalletMain->xionTracker->UpdateState(m);
                }
            }
...
UniValue listzerocoinamounts(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    std::set<CMintMeta> setMints = pwalletMain->xionTracker->ListMints(true, true, true);
...
UniValue listspentzerocoins(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            "listspentzerocoins\n"
            "\nList all the spent xION mints in the wallet.\n" +
            HelpRequiringPassphrase() + "\n"
...
UniValue mintzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nMint the specified xION amount\n" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. amount      (numeric, required) Enter an amount of Piv to convert to xION\n"
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 4 || params.size() < 3)
        throw std::runtime_error(
            ...
            "\nExamples\n" +
            HelpExampleCli("spendzerocoin", "5000 false true \"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\"") +
            HelpExampleRpc("spendzerocoin", "5000 false true \"iVpPG131hKv1t6iSnbu9HRrhTC7oM2UEaj\""));
...
UniValue spendzerocoinmints(const UniValue& params, bool fHelp)
{
    ...
    return DoXionSpend(nAmount, false, true, vMintsSelected, address_str);
}


extern UniValue DoXionSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool ispublicspend)
{
...
UniValue resetmintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    std::set<CMintMeta> setMints = xionTracker->ListMints(false, false, true);
...
UniValue resetspentzerocoin(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    CxIONTracker* xionTracker = pwalletMain->xionTracker.get();
    std::set<CMintMeta> setMints = xionTracker->ListMints(false, false, false);
    ...
    for (CZerocoinSpend spend : listUnconfirmedSpends) {
        for (auto& meta : setMints) {
            if (meta.hashSerial == GetSerialHash(spend.GetSerial())) {
                xionTracker->SetPubcoinNotUsed(meta.hashPubcoin);
...
UniValue exportzerocoins(const UniValue& params, bool fHelp)
{
    if(fHelp || params.empty() || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"denomination\"         (integer, optional) Export a specific denomination of xION\n"

            "\nResult:\n"
            "[                   (array of json object)\n"
            "  {\n"
            "    \"id\": \"serial hash\",  (string) the mint's xION serial hash \n"
            ...
            "    \"v\": version,   (numeric) The version of the xION\n"
            "    \"k\": \"privkey\"  (string) The xION private key (V2+ xION only)\n"
            "  }\n"
            "  ,...\n"
            "]\n"
    ...
    CxIONTracker* xionTracker = pwalletMain->xionTracker.get();
    std::set<CMintMeta> setMints = xionTracker->ListMints(!fIncludeSpent, false, false);
...
UniValue importzerocoins(const UniValue& params, bool fHelp)
{
    if(fHelp || params.size() == 0)
        throw std::runtime_error(
            ...
            "  \"value\": amount    (numeric) The total xION value of zerocoin mints that were added\n"
            "}\n"
    ...
    for (unsigned int idx = 0; idx < arrMints.size(); idx++) {
        ...
        pwalletMain->xionTracker->Add(mint, true);
        count++;
...
UniValue dxionstate(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
                "dxionstate\n"
                        "\nThe current state of the mintpool of the deterministic xION wallet.\n" +
                HelpRequiringPassphrase() + "\n"
    ...
    obj.push_back(Pair("dxion_count", nCount));
...
UniValue spendrawzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 5)
        throw std::runtime_error(
            ...
            "5. \"address\"          (string, optional) ION address to spend to. If not specified, spend to change add.\n"
...
UniValue clearspendcache(const UniValue& params, bool fHelp)
{
    if(fHelp || params.size() != 0)
        throw std::runtime_error(
            "clearspendcache\n"
            "\nClear the pre-computed xION spend cache, and database.\n" +
            HelpRequiringPassphrase() + "\n"
...

    {
        int nTries = 0;
        while (nTries < 100) {
            TRY_LOCK(xionTracker->cs_spendcache, fLocked);
            if (fLocked) {
                if (xionTracker->ClearSpendCache()) {
