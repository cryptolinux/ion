...
//
//     src/qt/test/test_ion-qt -platform xcb      # Linux
//     src/qt/test/test_ion-qt -platform windows  # Windows
//     src/qt/test/test_ion-qt -platform cocoa    # macOS
void TestGUI()
{
    GUIUtil::loadFonts();
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: ion:")) != -1);
