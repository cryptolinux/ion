...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("2630250cbfb6d612017cba0c9c439ded242d9b64816d6527b3f313ac285d0f7c");
        ...
        consensus.DIP0003EnforcementHash = uint256S("2630250cbfb6d612017cba0c9c439ded242d9b64816d6527b3f313ac285d0f7c");
        ...
        consensus.nBlockZerocoinV2 = 400;
        ...
        // ATP
        consensus.ATPStartHeight = 900; // Start enforcing the Atomic Token Protocol (ATP) for blocks with version 11 and higher
        ...
        chainTxData = ChainTxData{
            ...
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.0    // * estimated number of transactions per second after that timestamp (2 per minute)
        };
