...
*/
    ...
    LogPrint(BCLog::BENCHMARK, "    - Ion specific: %.2fms [%.2fs]\n", 0.001 * (nTime5 - nTime4), nTimeIonSpecific * 0.000001);
...
/*
//  If refactored: move to SyncTransaction
    //Record xION serials
    if (pwalletMain) {
