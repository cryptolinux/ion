...
enum ServiceFlags : uint64_t {
    ...
    // set by all Ion Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Ion Core does not support this but a patch set called Bitcoin XT does.
