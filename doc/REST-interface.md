...
Example:
```
$ curl localhost:27171/rest/getutxos/checkmempool/b2cdfd7b89def827ff8af7cd9bff7627ff72e5e8b0f71210f92ea7a4000c5d75-0.json 2>/dev/null | json_pp
{
   "chainHeight" : 325347,
...
* mempoolminfee : (numeric) minimum feerate (ION per KB) for tx to be accepted
