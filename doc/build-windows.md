...
Note that for WSL the Ion Core source path should be somewhere in the default mount file system, for
example /usr/src/ion, AND not under /mnt/d/. If this is not the case the dependency autoconf scripts may fail.
