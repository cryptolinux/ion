...
class TestNode():
    ...
    def __del__(self):
        # Ensure that we don't leave any iond processes lying around after
        # the test ends
    ...
    def start(self, extra_args=None, stderr=None, *args, **kwargs):
        ...
        # unclean shutdown), it will get overwritten anyway by iond, and
...
class TestNodeCLI():
    ...
    def __init__(self, binary, datadir):
        ...
        self.input = None
        self.log = logging.getLogger('TestFramework.ioncli')
    ...
    def send_cli(self, command=None, *args, **kwargs):
        ...
        self.log.debug("Running ion-cli command: %s" % command)
